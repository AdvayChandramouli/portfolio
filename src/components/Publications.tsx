...
export function Publications() {
  return (
    <section id="publications" className="scroll-mt-20" aria-labelledby="publications-heading">
      <h2
      ...
      <ul className="space-y-6">
        {publications.map((pub) => (
          <li key={pub.title} className="border-b border-border pb-6 last:border-0 last:pb-0">
            <p className="font-serif text-[1.05rem] text-foreground leading-relaxed mb-1">
              {pub.title}
            </p>
            <p className="font-sans text-sm text-muted-light mb-2">{pub.venue}</p>
            {pub.links && (
