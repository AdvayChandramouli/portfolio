...
export function ExpandableProjectCard({
  ...
  function handleActivate(opener: HTMLElement) {
    onOpen(project, opener);
  }
  ...
  return (
    <article
      ...
      className="group relative cursor-pointer p-6 bg-glass-bg backdrop-blur-md glass-backdrop-md border border-glass-border rounded-xl shadow-glass outline-none transition-all duration-300 ease-out hover:bg-glass-bg-hover hover:border-glass-border-hover hover:shadow-glass hover:-translate-y-0.5 motion-reduce:hover:translate-y-0 focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-background"
    >
      <div className="mb-2">
